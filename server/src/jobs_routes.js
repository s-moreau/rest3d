...
module.exports = function(server){
	...
	server.get(/^\/rest3d\/jobs\/status.*/, function (req, res, next) {
		var handler = new Handler(req, res, next);
	...
	server.post(/^\/rest3d\/jobs\/kill.*/, function (req, res, next) {
		var handler = new Handler(req, res, next);
	    handler.allowOrigin();
	    var result = {};
	...
	server.post(/^\/rest3d\/jobs\/suspend.*/, function (req, res, next) {
		var handler = new Handler(req, res, next);
	    handler.allowOrigin();
	    var result = {};
    	var id = req.url.stringAfter('/job/');
	...
	server.post(/^\/rest3d\/jobs\/resume.*/, function (req, res, next) {
		var handler = new Handler(req, res, next);
	    handler.allowOrigin();
	    var result = {};
    	var id = req.url.stringAfter('/job/');
